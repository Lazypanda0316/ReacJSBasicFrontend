    ...
    <div className="relative top-0 left-0 w-full z-40 px-4 md:px-10 lg:px-15 bg-white shadow-md">
      <div className="flex flex-wrap justify-between items-center p-4 md:p-6">
        ...
        <div className="hidden md:flex gap-6 lg:gap-10 font-semibold">
          <NavLink
            to="/spare-parts"
            className="text-black text-base lg:text-xl hover:text-red-500 transition duration-300"
          >
            Home
          </NavLink>
          <NavLink
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <NavLink
            to="/SUI"
            className="text-black text-xl md:text-2xl cursor-pointer hover:text-red-500 transition duration-300"
          >
            <FaUser />
          </NavLink>
        </div>
