  ...
  return (
    <>
      <div className="flex justify-between p-6">
        ...
        <div className="w-full md:w-2/5 lg:w-3/5 border ml-auto p-4 font-medium font-archivo flex flex-col space-y-4 max-h-[500px] overflow-y-auto">

          {/* Rating and Total Reviews Section */}
